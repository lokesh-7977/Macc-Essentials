...
export default function Hero() {
  return (
    <div className='flex flex-col md:flex-row-reverse items-center justify-between h-screen bg-gradient-to-r  text-black'>
      ...
      <div className='flex-1 flex flex-col items-center justify-center p-8 text-center md:text-left'>
        <h1 className='text-4xl font-bold mb-4'>PROVIDING SERVICES  AT YOUR DOOR</h1>
