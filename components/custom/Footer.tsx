...
export default function Footer() {
  return (
    <footer className='bg-white text-black py-10 px-4'>
      <div className='container mx-auto flex flex-col md:flex-row justify-between md:justify-center md:items-start gap-10 md:gap-20'>
        ...
        <div className='grid grid-rows-3 grid-cols-2 gap-x-40 gap-y-2'>
        ...
        <div className='flex flex-col items-start mb-6 md:mb-0 gap-y-6'>
          ...
          <form className='flex'>
            ...
            />
            <CgMail className='size-10 text-xl text-gray-700 active:text-blue-500 transition duration-300'/>
          </form>
